...
class NN_RL_RMSE(DMM):
    def __init__(self, method_name, attributes, lockin_percentage=None, time_to_trigger=None, simulation_length=100, model_name=None, save_records=False, csv_file_name=None, **kwargs):
    ...
    def saveData(self):
        pass
        #self.df.to_csv(self.csv_file_name, index=False)

    def recordData(self, data_inputs, data_output):
        pass
        #print("=== TO SAVE ===")
        #print(data_inputs)
        #print(data_output)
        #print("===============")
        #new_row = pd.DataFrame([{"episode": data_inputs[0], "reward": data_inputs[], "loss": 0.005}])
    ...
    def RMSE_RL(self, normalized_inputs):
        ...
        inpt_list[max_index]['Delay'] = self.inputs_bkp[max_index]['Delay']
        inpt_list[max_index]['Jitter'] = self.inputs_bkp[max_index]['Jitter']
