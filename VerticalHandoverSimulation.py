...
# WiFi's
wifi_1 = MNS("WiFi-1", 400, 60, 20, 2400000000, 20000000, 10, maximum_radius=150, predef_throughput=[200000000, 100000000, 30000000], predef_snr=[40, 25, 10], predef_rssi=[-50, -65, -80])
WNS_list.append(wifi_1)

wifi_2 = MNS("WiFi-2", 300, 30, 20, 5000000000, 80000000, 15, maximum_radius=90, predef_throughput=[1000000000, 500000000, 150000000], predef_snr=[40, 25, 15], predef_rssi=[-50, -65, -80])
WNS_list.append(wifi_2)

wifi_3 = MNS("WiFi-3", 100, 300, 20, 5000000000, 80000000, 15, maximum_radius=90, predef_throughput=[1000000000, 500000000, 150000000], predef_snr=[40, 25, 15], predef_rssi=[-50, -65, -80])
WNS_list.append(wifi_3)

wifi_4 = MNS("WiFi-4", 800, 800, 20, 5000000000, 80000000, 15, maximum_radius=90, predef_throughput=[1000000000, 500000000, 150000000], predef_snr=[40, 25, 15], predef_rssi=[-50, -65, -80])
WNS_list.append(wifi_4)

wifi_5 = MNS("WiFi-5", 150, 750, 20, 5000000000, 80000000, 15, maximum_radius=90, predef_throughput=[1000000000, 500000000, 150000000], predef_snr=[40, 25, 15], predef_rssi=[-50, -65, -80])
WNS_list.append(wifi_5)

wifi_6 = MNS("WiFi-6", 900, 500, 20, 2400000000, 20000000, 10, maximum_radius=150, predef_throughput=[200000000, 100000000, 30000000], predef_snr=[40, 25, 10], predef_rssi=[-50, -65, -80])
WNS_list.append(wifi_6)


# NB-IoT 5G
nbiot_5g_1 = MNS("NBIoT-5g-1", -6500, -6500, 30, 800000000, 1400000, 2, maximum_radius=15000, predef_throughput=[100000, 50000, 10000], predef_snr=[10, 5, 2], predef_rssi=[-90, -105, -115])
WNS_list.append(nbiot_5g_1)


# LoRa's
LoRa_1 = MNS("LoRa-1", 7100, -7250, 14, 868000000, 250000, 0, maximum_radius=10000, predef_throughput=[50000, 10000, 1000], predef_snr=[10, 5, 0], predef_rssi=[-80, -100, -120])
WNS_list.append(LoRa_1)

LoRa_2 = MNS("LoRa-2", 7100, -7250, 14, 868000000, 250000, 0, maximum_radius=10000, predef_throughput=[50000, 10000, 1000], predef_snr=[10, 5, 0], predef_rssi=[-80, -100, -120])
WNS_list.append(LoRa_2)


# LTE 4G
LTE_4g = MNS("LTE-4g-1", 13000, 13000, 40, 868000000, 250000, 5, maximum_radius=30000, predef_throughput=[100000000, 40000000, 5000000], predef_snr=[15, 10, 5], predef_rssi=[-70, -90, -100])
WNS_list.append(LTE_4g)


# WiFi Max
wifi_max_1 = MNS("WiFi-Max-1", -2000, 3900, 40, 3000000000, 10000000, 10, maximum_radius=6000, predef_throughput=[40000000, 15000000, 2000000], predef_snr=[15, 10, 5], predef_rssi=[-60, -80, -90])
...
def calculate_parameters(device, x_position, y_position):
    ...
    decision = device_1.makeDecision(spmo, available_networks)
